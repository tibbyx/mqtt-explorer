...
export function ConnectionPanel({ onToggleConnect }: { onToggleConnect?: () => void } = {}) {
    ...
    return (
        <div className="flex-1 flex flex-col h-full bg-white dark:bg-gray-950 overflow-auto">
            ...
            <div className="flex flex-col justify-center items-center h-full">
                <div className="max-w-md w-full px-6 py-6 border rounded-lg shadow-sm bg-white dark:bg-gray-800">
